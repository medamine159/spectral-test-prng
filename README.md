...
In the context of a course i took in telecom Paris about Probabilistic Models and Machine Learning, we tackled the topic of numerical simulation where we talked about random generations,i tried to visualizes the **spectral properties** of different pseudo-random number generators:
